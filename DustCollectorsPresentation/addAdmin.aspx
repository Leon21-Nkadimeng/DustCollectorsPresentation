<%@ Page Title="" Language="C#" MasterPageFile="~/NavigationAndFooter.Master" AutoEventWireup="true" CodeBehind="addAdmin.aspx.cs" Inherits="DustCollectorsPresentation.addAdmin" %>
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
					<div class="p-b-30 m-lr-15-sm">
						...
						<div class="row p-b-25">
							<div class="col-sm-6 p-b-5">
								<label class="stext-102 cl3" for="name">Password</label>
								
								<asp:TextBox class="size-111 bor8 stext-102 cl2 p-lr-20" ID="txtPassword" runat="server" type="password" name="password"></asp:TextBox>
							</div>

							<div class="col-sm-6 p-b-5">
								<label class="stext-102 cl3" for="email">Confirm Password</label>
								<asp:TextBox class="size-111 bor8 stext-102 cl2 p-lr-20" ID="txtConfirmPassword" runat="server" type="password" name="password"></asp:TextBox>
							</div>
						</div>
							<div class="row p-b-5">
						...
						<div class="row p-b-25">
							<div class="col-sm-6 p-b-5">
								<asp:Button ID="btnAddAdmin" runat="server" Text="Add Admin" class="flex-c-m stext-101 cl0 size-112 bg7 bor11 hov-btn3 p-lr-15 trans-04 m-b-10" OnClick="btnAddAdmin_Click"  />
							</div>
